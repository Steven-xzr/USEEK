...
class DGCNN_partseg(nn.Module):
    def __init__(self, seg_num_all):
        ...
        self.conv7 = nn.Sequential(nn.Conv1d(16, 64, kernel_size=1, bias=False),
                                   self.bn7,
                                   nn.LeakyReLU(negative_slope=0.2))'''
        self.conv8 = nn.Sequential(nn.Conv1d(1024+64*3, 256, kernel_size=1, bias=False),
                                   self.bn8,
                                   nn.LeakyReLU(negative_slope=0.2))
    ...
    def forward(self, x):
        ...
        global_feature = x.reshape(batch_size, -1)                      # (batch_size, emb_dims)
        ...
        return x.permute(0, 2, 1), global_feature
